      ...
      <Modal>
        ...
        <ModalBody className="md:max-w-4xl">
          <div className="flex min-h-0 flex-1 flex-col">
            ...
            >
              <div
                className="relative min-h-0 flex-1 overflow-y-auto overscroll-y-contain [touch-action:pan-y] scroll-pb-4"
                tabIndex={0}
                role="region"
            ...
            <ModalFooter className="mt-auto shrink-0 gap-4">
              <ModalCloseButton />
...
const ProjectContents = ({ project }: { project: Project }) => {
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row md:justify-evenly max-w-full">
